...
const mockPodcasts: IPodcastData[] = [
  {
    ...
    attributes: {
      ...
      title:
        'Os perigos da automedicação: quando o cuidado se transforma em risco.',
      description:
        'Tomar um remédio "por conta própria" pode parecer inofensivo. Uma forma rápida de aliviar um sintoma, mas essa prática aparentemente simples pode esconder riscos significativos para a saúde.',
      imageUrl:
        'https://i.scdn.co/image/ab6765630000ba8a0f8b3d8b0f8b3d8b0f8b3d8b',
  ...
  },
  {
    ...
    attributes: {
      ...
      title:
        'Dispraxia: o desafio invisível do corpo e do cérebro de Daniel Radcliffe.',
      description:
        'Por trás do sucesso e da fama, há histórias de superação que lembram o quanto o cérebro humano é complexo e resiliente.',
      imageUrl:
        'https://i.scdn.co/image/ab6765630000ba8a0f8b3d8b0f8b3d8b0f8b3d8b',
  ...
  },
  {
    ...
    attributes: {
      ...
      description:
        'Apostar pode parecer inofensivo no começo. Uma forma de diversão, emoção ou alívio rápido. Mas, para algumas pessoas, essa atividade pode se transformar em um transtorno sério.',
      imageUrl:
        'https://i.scdn.co/image/ab6765630000ba8a0f8b3d8b0f8b3d8b0f8b3d8b',
