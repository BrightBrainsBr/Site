      ...
      >
        ...
        <div className="border-b border-[rgba(255,255,255,0.06)] px-4 py-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-[14px] font-bold text-[#c5e155]">
                BrightMonitor
              </div>
              <div className="text-[9px] text-[#64748b]">Saúde Mental Corporativa</div>
            </div>
          </div>
        </div>
        ...
        {cycles.length > 0 && (
          <div className="border-b border-[rgba(255,255,255,0.06)] px-4 py-3">
            <label className="mb-1 block text-[9px] font-semibold uppercase tracking-[0.08em] text-[#64748b]">
              Ciclo
            </label>
            <select
              value={activeCycleId ?? ''}
              onChange={(e) => setCycleId(e.target.value)}
              className="w-full rounded-md border border-[rgba(255,255,255,0.06)] bg-[#111b2e] px-2 py-1.5 text-[12px] text-[#e2e8f0] focus:border-[rgba(197,225,85,0.3)] focus:outline-none"
            >
              {cycles.map((c) => (
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-3">
          <div className="mb-1.5 px-2 text-[9px] font-semibold uppercase tracking-[0.08em] text-[#64748b]">
            Módulos
          </div>
          {visibleTabs.map((t) => (
            <button
              ...
              className={`mb-0.5 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-[12px] transition-all ${
                activeTab === t.id
        ...
        <div className="border-t border-[rgba(255,255,255,0.06)] px-4 py-3">
          ...
          {hasValidGro && (
            <span className="mt-1.5 inline-block rounded-full bg-[rgba(34,197,94,0.15)] px-2 py-0.5 text-[9px] font-semibold text-[#22c55e]">
              ✓ GRO Emitido
            </span>
          )}
          {!hasValidGro && compliance && (
            <span className="mt-1.5 inline-block rounded-full bg-[rgba(234,179,8,0.15)] px-2 py-0.5 text-[9px] font-semibold text-[#eab308]">
              ⚠ GRO Pendente
            </span>
          )}
        </div>
      ...
      <div className="flex flex-1 flex-col lg:ml-[220px]">
        ...
        <header className="flex items-center justify-between border-b border-[rgba(255,255,255,0.06)] bg-[#0c1425] px-4 py-2.5 lg:px-6">
          ...
          <div className="hidden items-center gap-1.5 lg:flex">
            ...
            <span className="text-[13px] font-semibold text-[#c5e155]">
              {companyName ?? 'Empresa'}
            </span>
          </div>
