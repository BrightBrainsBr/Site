    ...
    <div className="rounded-xl border border-[rgba(255,255,255,0.08)] bg-[#0E1E33] p-5">
      ...
      {customDepts.length > 0 && (
        <div className="mb-3 flex flex-wrap gap-2">
          {customDepts.map((dept) => (
            <span
              key={dept}
              className="flex items-center gap-1.5 rounded-full border border-[#14B8A6]/40 bg-[#14B8A6]/15 px-3 py-1 text-[12px] font-medium text-[#14B8A6]"
            >
              {dept}
              <button
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-lg bg-[#0D9488] px-3 py-2 text-[12px] font-semibold text-white disabled:opacity-40"
        >
