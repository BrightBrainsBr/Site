...
const CHECKLIST_ITEMS = [
  {
    id: 'gro-program',
    label: 'Programa de GRO estruturado e documentado',
    done: true,
    status: 'Concluído',
  },
  {
    id: 'risk-mapping',
    label: 'Mapeamento de riscos psicossociais por setor',
    done: true,
    status: 'Concluído',
  },
  {
    id: 'neuropsych',
    label: 'Avaliação neuropsicológica aplicada',
    done: true,
    status: 'Concluído',
  },
  {
    id: 'cfm-laudo',
    label: 'Laudo CFM emitido e assinado',
    done: true,
    status: 'Concluído',
  },
  {
    id: 'esocial',
    label: 'Dados enviados ao eSocial',
    done: true,
    status: 'Concluído',
  },
  {
    id: 'lgpd',
    label: 'LGPD: termos de consentimento coletados',
    done: true,
    status: 'Concluído',
  },
  {
    id: 'risk-report',
    label: 'Relatório de gestão de riscos entregue',
    done: true,
    status: 'Concluído',
  },
  {
    id: 'action-plan',
    label: 'Plano de ação para riscos elevados',
    done: false,
    status: 'Em andamento',
  },
  {
    id: 'reeval',
    label: 'Reavaliação semestral agendada',
    done: false,
    status: 'Agendado — Jul/2026',
  },
]
...
const TIMELINE_ITEMS = [
  {
    ...
    title: 'Kickoff e cadastro de colaboradores',
    date: 'Outubro 2025',
    status: 'Concluído',
  },
  {
    done: true,
    title: 'Aplicação das avaliações neuropsicológicas',
    date: 'Nov – Dez 2025',
    status: '100% concluído',
  },
  {
    done: true,
    title: 'Emissão dos relatórios individuais',
    date: 'Janeiro 2026',
    status: 'Entregue',
  },
  {
    done: true,
    title: 'GRO consolidado + laudo CFM emitido',
    date: 'Fevereiro 2026',
    status: 'Emitido e assinado',
  },
  {
    done: true,
    title: 'Envio ao eSocial e MTE',
    date: 'Março 2026',
    status: 'Protocolo registrado',
  },
  {
    done: false,
    title: 'Plano de ação — colaboradores em risco',
    date: 'Abril 2026',
    status: 'Em elaboração',
  },
  {
    done: false,
    title: 'Reavaliação semestral (Ciclo 2)',
    date: 'Julho 2026',
    status: 'Agendado',
  },
]
...
const LEGAL_DOCS = [
  {
    name: 'GRO – Gestão de Riscos Ocupacionais',
    info: 'PDF · 48 págs · Emitido 02/2026',
  },
  { name: 'Laudo CFM 2454/2026', info: 'PDF · Assinado digitalmente' },
  { name: 'Relatório de conformidade NR-1', info: 'PDF · Enviado ao eSocial' },
  {
    name: 'Certificado LGPD – Bright Brains',
    info: 'PDF · ISO 27001 certificado',
  },
]
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.08)] bg-[#0E1E33] px-4 py-6 text-center">
          <p className="mb-2 text-[11px] uppercase tracking-[0.5px] text-[#64748B]">
            Status GRO
          </p>
          <p className="text-[48px] font-bold leading-none text-[#34D399]">✓</p>
          <p className="mt-1 text-[18px] font-bold text-[#34D399]">
            GRO Emitido
          </p>
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.08)] bg-[#0E1E33] px-4 py-6 text-center">
          ...
          <p className="mt-1.5 text-[12px] text-[#64748B]">
            ...
            <br />
            Teleavaliação neuropsicológica
          </p>
          <div className="mt-3 rounded-lg border border-[rgba(52,211,153,0.2)] bg-[rgba(52,211,153,0.08)] px-2 py-2 text-[11px] text-[#34D399]">
        ...
        <div className="rounded-xl border border-[rgba(255,255,255,0.08)] bg-[#0E1E33] px-4 py-6 text-center">
          ...
          <p className="mt-1.5 text-[12px] text-[#64748B]">
            {approvedCount} de {totalEvaluations} colaboradores
            <br />
            elegíveis avaliados
          </p>
                ...
                <div className="flex flex-col items-center">
                  <div
                    className={`mt-0.5 h-2.5 w-2.5 shrink-0 rounded-full ${
                      item.done ? 'bg-[#10B981]' : 'bg-[rgba(255,255,255,0.08)]'
                    }`}
                    style={
                      !item.done
                        ? {
