  ...
  return (
    <div className="space-y-4">
      ...
      >
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
          <div className="text-center sm:text-left">
            <p className="text-[14px] uppercase tracking-wider text-[#64748b]">
              Conformidade NR-1
            </p>
          ...
          <div className="w-full max-w-xs">
            <div className="mb-1 text-right text-[13px] text-[#64748b]">
              {progressPct}%
            </div>
      ...
      <div
        ...
        style={{ background: 'rgba(255,255,255,0.03)' }}
      >
        <h3 className="mb-4 text-[17px] font-semibold text-[#e2e8f0]">
          ...
          <div>
            {items.map((item) => {
              ...
              return (
                ...
                >
                  <div
                    className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[13px]"
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start gap-2">
                      <span className="shrink-0 rounded bg-[rgba(255,255,255,0.06)] px-1.5 py-0.5 font-mono text-[12px] text-[#c5e155]">
                        {item.ref}
                      </span>
