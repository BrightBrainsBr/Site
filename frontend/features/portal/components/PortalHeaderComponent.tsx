...
export function PortalHeaderComponent({
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#1a3a5c] bg-[#0c1a2e] px-4 py-3 md:px-8 md:py-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 md:gap-6">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#00c9b1] to-[#0090ff]">
            <svg
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <span className="hidden text-xs text-[#5a7fa0] sm:inline">
            Pendentes: {pendingCount} · Aprovados: {approvedCount}
          </span>
          <span className="whitespace-nowrap rounded-full bg-[#00c9b1] px-2.5 py-1 text-[11px] font-bold text-black md:px-3 md:text-xs">
            {totalCount} pac.
          </span>
        </div>
      </div>
